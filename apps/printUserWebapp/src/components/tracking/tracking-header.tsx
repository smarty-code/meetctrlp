...
export function TrackingHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 sm:h-16 w-full items-center justify-between border-b border-graphite/15 bg-paper/95 px-4 backdrop-blur-xs sm:px-6">
      {/* Left: Back Navigation Arrow + Title */}
