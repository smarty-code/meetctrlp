...
The six screen architecture reduces navigation complexity while preserving the complete MVP capability set.

The product is therefore **six primary screens, not six reduced feature areas**. The underlying MVP functionality remains intact and is distributed across screens, drawers, contextual panels, onboarding, and system states.
